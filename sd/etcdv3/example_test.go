...
func Example() {
	...
	var (
		etcdServer = "192.168.0.71:12379" // in the change from v2 to v3, the schema is no longer necessary if connecting directly to an etcd v3 instance
	...
	req := struct{}{}
	if _, err = retry.Process(ctx, req); err != nil {
		panic(err)
	}
}
