...
var file_cluster_proto_rawDesc = []byte{
	...
	0x61, 0x64, 0x22, 0xad, 0x03, 0x0a, 0x0a, 0x55, 0x73, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75,
...
var file_cluster_proto_goTypes = []interface{}{
	...
	(*UserStatus)(nil),         // 2: nakama.cluster.UserStatus
	(*ProxyMessage)(nil),       // 3: nakama.cluster.ProxyMessage
	(*NodeStatus)(nil),         // 4: nakama.cluster.NodeStatus
	(*Bytes)(nil),              // 5: nakama.cluster.Bytes
	(*Error)(nil),              // 6: nakama.cluster.Error
	nil,                        // 7: nakama.cluster.UserStatus.VarsEntry
	nil,                        // 8: nakama.cluster.Error.ContextEntry
	(*rtapi.Envelope)(nil),     // 9: nakama.realtime.Envelope
	(*rtapi.UserPresence)(nil), // 10: nakama.realtime.UserPresence
}
var file_cluster_proto_depIdxs = []int32{
	9,  // 0: nakama.cluster.Envelope.NakamaRtapi:type_name -> nakama.realtime.Envelope
	5,  // 1: nakama.cluster.Envelope.bytes:type_name -> nakama.cluster.Bytes
	6,  // 2: nakama.cluster.Envelope.error:type_name -> nakama.cluster.Error
	3,  // 3: nakama.cluster.Envelope.proxy:type_name -> nakama.cluster.ProxyMessage
	2,  // 4: nakama.cluster.Envelope.userStatus:type_name -> nakama.cluster.UserStatus
	7,  // 5: nakama.cluster.UserStatus.vars:type_name -> nakama.cluster.UserStatus.VarsEntry
	0,  // 6: nakama.cluster.UserStatus.action:type_name -> nakama.cluster.UserStatus.Action
	10, // 7: nakama.cluster.ProxyMessage.presences:type_name -> nakama.realtime.UserPresence
	8,  // 8: nakama.cluster.Error.context:type_name -> nakama.cluster.Error.ContextEntry
	1,  // 9: nakama.cluster.ApiServer.Call:input_type -> nakama.cluster.Envelope
	1,  // 10: nakama.cluster.ApiServer.Stream:input_type -> nakama.cluster.Envelope
	1,  // 11: nakama.cluster.ApiServer.Call:output_type -> nakama.cluster.Envelope
	1,  // 12: nakama.cluster.ApiServer.Stream:output_type -> nakama.cluster.Envelope
